...
public class HandleFrames {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//body/div/div/form/div/div/div[@role='list']/div[@role='listitem']/div/div/div/div[@role='list']/div[@role='listitem']/label[@for='i27']/div/div[@aria-label='General Web Automation']/div[2]")).click();
